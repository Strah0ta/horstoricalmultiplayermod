...
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.05, 0.0 } -- SPEED 4 IS 0.1 IN VANILLA  game speeds for each level. Must be 5 entries with last one 0 for unbound 
...
NDefines.NMilitary.PLAN_AREA_DEFENSE_FORT_IMPORTANCE = 2	--you need less divs on a city tile/fort and not more --Used when calculating the calue of defense area provinces for the battle plan system works as multipliers on the rest
NDefines.NMilitary.PLAN_AREA_DEFENSE_COASTAL_FORT_IMPORTANCE = 2-- Used when calculating the calue of defense area provinces for the battle plan system
...
NDefines.NAir.COMBAT_MAX_WINGS_AT_ONCE = 3500                         -- WAS 10000 | Max amount of air wings in one combat simulation. The higher value, the quicker countries may loose their wings. It's a gameplay balance value.
NDefines.NAir.COMBAT_MAX_WINGS_AT_GROUND_ATTACK = 3500                -- WAS 10000 | we can really pounce a land strike and escalate
NDefines.NAir.COMBAT_MAX_WINGS_AT_ONCE_PORT_STRIKE = 3500       	 -- WAS 10000 | we can really pounce a naval strike and escalate
...
NDefines.NCountry.BASE_FUEL_CAPACITY = 20000                -- WAS 50k, increased to make the fuel system more smooth with minor AC
