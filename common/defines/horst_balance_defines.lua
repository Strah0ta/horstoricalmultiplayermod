...
NDefines.NMilitary.COMBAT_VALUE_ORG_IMPORTANCE = 0 		-- VANILLA 1     Multiplier on TotalOrganisation when determining the combat value of a division
...
NDefines.NAir.COMBAT_MULTIPLANE_CAP = 1.6                  -- VANILLA 3; GDU 1.6; LW 2   --I Compare Horst against GDU/LW as it is more comparable to these mods than DC/WWB/HoO or HMM/elwolfmod   
NDefines.NAir.COMBAT_DAMAGE_SCALE = 0.042				-- Vanilla 0,10
...
NDefines.NAir.DETECT_CHANCE_FROM_AIRCRAFTS = 0.8
...
NDefines.NAir.ESCORT_FACTOR = 5.5 -- (2 -> 7) to make sure that escorted planes are still capable of bombing, with equal escorts/interceptors most of bombers get through Keep in mind that these values will also affect how cas/tac/strat bombers work, they make escorting planes much more important (which imo is 100% fine)
...
--NDefines.NCountry.REINFORCEMENT_DELIVERY_SPEED_MIN = 0.7   
...
NDefines.NCountry.SUPPLY_CONVOY_FACTOR = 0.07					-- How many convoys each supply needs
